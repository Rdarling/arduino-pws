...
{
  Serial.begin(9600);
  Serial.println("Weather Shield Example with GPS - RWD");
...
void loop()
{
  ...
  if(millis() - lastSecond >= 1000)
  {
    ...
    //digitalWrite(STAT2, HIGH); //Turn on stat green LED --RWD
    //Report all readings every second
    printWeather();

    digitalWrite(STAT1, LOW); //Turn off stat Blue LED
    
    //digitalWrite(STAT2, LOW); //Turn on stat green LED--RWD
  }

  smartdelay(800); //Wait 1 second, and gather GPS data    --rwd
}
...
void calcWeather()
{
  ...
  //Calc humidity -- the SI7021
  humidity = myHumidity.getRH();
  temp_h = myHumidity.getTempF(); //--rwd
//  Serial.print(" SI7021 Temp: ");             //         --rwd
//  Serial.print(temp_h, 2);              //        --rwd

  //Calc tempf from pressure sensor - MPL3115a
  temp_p = myPressure.readTempF();
//  Serial.print(" MPL3115A2 Temp:");
